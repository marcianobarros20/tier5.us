<?php
/*
Plugin Name: WPBakery Visual Composer 4.3.5 for Zephyr
...
class Vc_Manager {
	...
	private $plugin_name = 'zephyr_js_composer/zephyr_js_composer.php';
	/**
	...
	public function isNetworkPlugin() {
		if ( is_null( $this->is_network_plugin ) ) {
			...
			if ( is_multisite() && ( is_plugin_active_for_network( 'zephyr_js_composer/zephyr_js_composer.php' )
			  || is_network_only_plugin( 'zephyr_js_composer/zephyr_js_composer.php' ) )
			) {

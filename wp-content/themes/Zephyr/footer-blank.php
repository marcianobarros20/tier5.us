...
<script type="text/javascript">
	...
	window.headerMainHeight = "<?php echo esc_js($smof_data['header_main_height']); ?>";
	<?php endif; ?>
	...
	window.headerMainShrinkedHeight = "<?php echo esc_js($smof_data['header_main_shrinked_height']); ?>";
	<?php endif; ?>
	<?php if ( ! empty($smof_data['header_extra_height']) AND $smof_data['header_extra_height'] >= 36 AND $smof_data['header_extra_height'] <= 60): ?>
	window.headerExtraHeight = "<?php echo esc_js($smof_data['header_extra_height']); ?>";
	<?php endif; ?>
	<?php if ( ! empty($smof_data['disable_sticky_header_width'])): ?>
	window.headerDisableStickyHeaderWidth = "<?php echo esc_js($smof_data['disable_sticky_header_width']); ?>";
	<?php endif; ?>
	<?php if ( ! empty($smof_data['disable_animation_width'])): ?>
	window.headerDisableAnimationWidth = "<?php echo esc_js($smof_data['disable_animation_width']); ?>";
	<?php endif; ?>
	...
	window.firstSubmainPadding = <?php echo esc_js($l_submain_padding); ?>;
	<?php endif; ?>

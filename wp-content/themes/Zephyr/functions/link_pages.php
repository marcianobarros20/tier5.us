...
function wp_link_pages_args_prevnext_add($args)
{
	...
	if ( ! $args['next_or_number'] == 'next_and_number' OR ! $more)
		return $args; # exit early

	$args['next_or_number'] = 'number'; # keep numbering for the main part

	// Filling values, that can be possibly not defined
	$args = array_merge(array_fill_keys(array('link_classes', 'prev_link_classes', 'next_link_classes'), ''), $args);

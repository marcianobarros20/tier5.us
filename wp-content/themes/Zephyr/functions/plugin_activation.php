...
function my_theme_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			'name'     				=> 'WPBakery Visual Composer 4.3.5 for Zephyr', // The plugin name
			'slug'     				=> 'zephyr_js_composer', // The plugin slug (typically the folder name)
			'source'   				=> get_template_directory() . '/vendor/plugins/zephyr_js_composer.zip', // The plugin source
